...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            ...
            case CODE_WEATHER:
                cursor = database.query(WeatherEntry.TABLE_NAME, projection, selection,
                        selectionArgs, null, null, sortOrder);
                break;
            case CODE_WEATHER_WITH_DATE:
                String date = uri.getLastPathSegment();
                String selectionString = WeatherEntry.COLUMN_DATE + "=?";
                String[] selectionArgsArray = new String[]{date};
                cursor = database.query(WeatherEntry.TABLE_NAME, projection, selectionString,
                        selectionArgsArray, null, null, sortOrder);
                break;
            default:
