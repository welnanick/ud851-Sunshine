...
public class DetailActivity extends AppCompatActivity
    ...
    private Intent createShareForecastIntent() {
        ...
        Intent shareIntent = ShareCompat.IntentBuilder.from(this).setType("text/plain").setText(
                mForecastSummary + FORECAST_SHARE_HASHTAG).getIntent();
